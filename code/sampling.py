...
def split_noniid(dataset, num_users, num_shards_per_user=2):
    """
...
if __name__ == '__main__':
    ...
    trainset = datasets.CIFAR10('/n/holyscratch01/kung_lab/xin/cifar_data', train=True,  download=False)

    num = 50
    
    dict_users = cifar_noniid(trainset, num, num_shards_per_user=2)
